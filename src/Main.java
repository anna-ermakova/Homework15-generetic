public class Main {
    public static void main(String[] args) {
        ...
        Bus liaz = new Bus("Лиаз", "ЛиАЗ-5256", 3.5, 5.6, 136, Capasity.AVERAGE);
        Bus paz = new Bus("ПАЗ", "Вектор", 1.8, 5.4, 128, Capasity.BIG);
        Bus gaz = new Bus("Газ", "Газель Next A63R42", 3.5, 5, 128.2, Capasity.SMALL);
        Bus paz320412 = new Bus("ПАЗ", "ЯМ353423", 3.5, 4.9, 128.2, Capasity.EXTRA_SMALL);
